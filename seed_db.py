...
def seed(cur):
    ...
    ch_general, ch_geometry, ch_committee, ch_kavish_dev, ch_announce, ch_founders = (
        channel_ids
    )
    ...
    messages = [
        (
            ch_general,
            kavish,
            "Welcome everyone to the Math Club general channel.",
            "2026-04-01 10:10:00",
        ),
        ...
        (
            ch_general,
            pooja,
            "Can someone explain perpendicular bisectors?",
            "2026-04-02 11:10:00",
        ),
        (
            ch_geometry,
            kavish,
            "Today we discuss perpendicular lines in geometry.",
            "2026-04-02 10:40:00",
        ),
        (
            ch_geometry,
            dev,
            "Two lines are perpendicular if they meet at 90 degrees.",
            "2026-04-02 10:45:00",
        ),
        (
            ch_geometry,
            yash,
            "I will share more examples tomorrow.",
            "2026-04-04 13:10:00",
        ),
        (
            ch_committee,
            kavish,
            "Committee meeting starts at 5 PM.",
            "2026-04-03 15:10:00",
        ),
        ...
        (
            ch_kavish_dev,
            kavish,
            "Hi Dev, are you free for a quick chat?",
            "2026-04-03 16:05:00",
        ),
        ...
        (
            ch_announce,
            david,
            "Welcome to the Startup Team announcements channel.",
            "2026-04-02 11:10:00",
        ),
        (
            ch_announce,
        ...
        (
            ch_founders,
            david,
            "Founders meeting tomorrow morning.",
            "2026-04-03 11:40:00",
        ),
        (
            ch_founders,
            vansh,
            "Understood. I will prepare the deck.",
            "2026-04-03 11:45:00",
        ),
    ]
    cur.executemany(
